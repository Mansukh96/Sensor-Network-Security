...
#define MAC_SHORT_ADDRESS_VALUE 0x0002 // Also referred to as NodeID
...
#define MAC_COORD_EUID_BYTE1 0x78   
#define MAC_COORD_EUID_BYTE0 0x27
...
// APP configuration
#define NODE_TYPE TEMP_ACC_SENSOR // Also referred to as TypeID
#define DATA_PERIODICITY 20 // Periodicity in seconds for sending sensor data
